/*-----------------------------------------------------------------------------------
    Template Name: Mamachino Kinder Garden Booking HTML Template
...
(function ($) {
	...
	mirandaDoc = {
		...
		roomSlider() {
			var sliderImg = $('.rooms-slider-one'),
				sliderContent = $('.plane-content-slider'),
		...
		//===== 06. Feature Room Slider
		featureRoom() {
			var fslider = $('.feature-plane-slider');
			var arrows = $('.feature-plane-arrow');
			fslider.slick({
				slidesToShow: 3,
				slidesToScroll: 1,
				fade: false,
		...
		roomDetailsSlider() {
			var roomDetailsSlider = $('.plane-details-slider');
			var roomDetailsSliderNav = $('.plane-details-slider-nav');
			roomDetailsSlider.slick({
				...
				arrows: false,
				dots: false,
				asNavFor: '.plane-details-slider-nav'
			});
			roomDetailsSliderNav.slick({
			 slidesToShow: 4,
			 slidesToScroll: 1,
			 asNavFor: '.plane-details-slider',
			 dots: false,
			 arrows: false,
			 centerMode: false,
			 focusOnSelect: true,
	...
	$(document).ready(function () {
		...
		$('.plane-book').on('click', function (e) {
			e.preventDefault();
